...
@section('content')
    <div class="card">
        <div class="card-body">
            <form action="{{route('user.get.fdtl.report')}}" method="post" id="reportForm">
                @csrf
                <div class="row">
                    <div class="col-md-3">
...
@section('js')
        ...
        <script>
            ...
            {   
                ...
                window.open("{{url('users/report/print')}}"+'/'+user_id+'/'+from_date+'/'+to_date,'printDiv','height=900,width=900');
            }
        </script>
@endsection