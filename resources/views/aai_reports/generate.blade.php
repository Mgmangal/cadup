                ...
                <div class="row m-3">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="booking_date" class="form-control dates" value="{{Carbon\Carbon::parse(is_get_date_time_format($data->departure_time),'UTC')->setTimezone('Asia/Kolkata')->format('d-m-Y H:i')}}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="form-label">Modification Date</label>
                            <input type="text" name="modification_date" class="form-control dates" value="{{Carbon\Carbon::parse(is_get_date_time_format($data->departure_time),'UTC')->setTimezone('Asia/Kolkata')->format('d-m-Y H:i')}}">
                       </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="form-label">Original PNR</label>
                            <input type="text" class="form-control auto_complete_input" name="original_pnr" value="{{ date('dmY', strtotime(Carbon\Carbon::parse(is_get_date_time_format($data->departure_time),'UTC')->setTimezone('Asia/Kolkata')->format('d-m-Y H:i'))) . str_replace('-', '', $data->aircraft->call_sign) . date('Hi', strtotime(Carbon\Carbon::parse(is_get_date_time_format($data->departure_time),'UTC')->setTimezone('Asia/Kolkata')->format('d-m-Y H:i'))) }}" placeholder="Please Enter Original PNR">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="form-label">Parent PNR</label>
                            <input type="text" class="form-control auto_complete_input" name="parent_pnr" value="{{ date('dmY', strtotime(Carbon\Carbon::parse(is_get_date_time_format($data->departure_time),'UTC')->setTimezone('Asia/Kolkata')->format('d-m-Y H:i'))) . str_replace('-', '', $data->aircraft->call_sign) . date('Hi', strtotime(Carbon\Carbon::parse(is_get_date_time_format($data->departure_time),'UTC')->setTimezone('Asia/Kolkata')->format('d-m-Y H:i'))) }}" placeholder="Please Enter Parent PNR">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="departure_date" class="form-control dates" value="{{Carbon\Carbon::parse(is_get_date_time_format($data->departure_time),'UTC')->setTimezone('Asia/Kolkata')->format('d-m-Y H:i')}}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="form-label">Departure Time UTC</label>
                            <input type="text" name="departure_date_utc" class="form-control dates" value="{{Carbon\Carbon::parse(is_get_date_time_format($data->departure_time),'UTC')->format('d-m-Y H:i')}}">
                       </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="form-label">Departure Time Local</label>
                            <input type="text" name="departure_date_local" class="form-control dates" value="{{Carbon\Carbon::parse(is_get_date_time_format($data->departure_time),'UTC')->setTimezone('Asia/Kolkata')->format('d-m-Y H:i')}}">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control auto_complete_input" name="total_pax" onchange="setStatus(this.value);"  value="{{$data->passenger}}" min="0" placeholder="Total number of Passenger">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control auto_complete_input" name="pnr_status" id="pnr_status" value="No show" placeholder="Please Enter PNR Status">
                        </div>
                    </div>
                </div>
